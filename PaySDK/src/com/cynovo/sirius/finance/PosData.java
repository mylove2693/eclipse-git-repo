...
public class PosData {
	...
	public void InitWithHostLink() {
		...
		// wanhaiping------------------------------------------------->begin
		/*
		 * if (HostlinkInterface.getAckNo() != null) { this.setAckNo(new
		 * String(HostlinkInterface.getAckNo())); }
		 * 
		 ...
		 * .getAuthorizationNo())); }
		 * 
		 * if (HostlinkInterface.getTraceNo() != null) { this.setTraceNo(new
		 * String(HostlinkInterface.getTraceNo())); }
		 * 
		 * if (HostlinkInterface.getSettlementDate() != null) {
		 * this.setClearingDate(new String(HostlinkInterface
		 * .getSettlementDate())); }
		 * 
		 * if (HostlinkInterface.getAmount() != null) { this.setAmount(new
		 * String(HostlinkInterface.getAmount())); }
		 * 
		 * if (HostlinkInterface.getDate() != null) { this.setDate(new
		 * String(HostlinkInterface.getDate())); }
		 * 
		 * if (HostlinkInterface.getTime() != null) { this.setTime(new
		 * String(HostlinkInterface.getTime())); }
		 * 
		 * if (HostlinkInterface.getMessageType() != null) {
		 * this.setMessageType(new String(HostlinkInterface.getMessageType()));
		 * }
		 * 
		 * if (HostlinkInterface.getAccountNo() != null) { this.setAccountNo(new
		 * String(HostlinkInterface.getAccountNo())); }
		 * 
		 * if (HostlinkInterface.getMerchantCode() != null) {
		 * this.setMerchantCode(new
		 * String(HostlinkInterface.getMerchantCode())); }
		 * 
		 * if (HostlinkInterface.getTerminalCode() != null) {
		 * this.setTerminalCode(new
		 * String(HostlinkInterface.getTerminalCode())); }
		 * 
		 * if (HostlinkInterface.getAdditionalData() != null) {
		 * this.setAdditionalData(new String(HostlinkInterface
		 * .getAdditionalData())); }
		 * 
		 * byte[] num = HostlinkInterface.getAdditionalData(); if (num != null)
		 * { byte[] issuer = new byte[11]; System.arraycopy(num, 0, issuer, 0,
		 * issuer.length); if (issuer != null) this.setIssuer(new
		 * String(issuer).trim());
		 * 
		 * num = HostlinkInterface.getAdditionalData(); System.arraycopy(num,
		 * 11, issuer, 0, issuer.length); if (issuer != null) this.setAcq(new
		 * String(issuer).trim()); }
		 * 
		 * if (HostlinkInterface.getBatchNo() != null) { this.setBatchid(new
		 * String(HostlinkInterface.getBatchNo())); }
		 */
		// deleted by
		// wanhaiping-------------------------------------------------<end
	}
