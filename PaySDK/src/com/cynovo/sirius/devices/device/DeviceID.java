...
public class DeviceID {
	...
	public static final int[] ALLDEVICE = { DEVICE_ID_MSR, DEVICE_ID_EMV,
			DEVICE_ID_NFC, DEVICE_ID_PRINTER, DEVICE_ID_CASHBOX,
			DEVICE_ID_SOFTPINPAD, DEVICE_ID_HARDPINPAD, DEVICE_ID_NETLINK };
}
