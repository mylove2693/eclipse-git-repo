...
public class HsmInterface {
	...
	/**
	 * close the device return value >= 0 : success (suggest 0) < 0 : error code
	 */
	 ...
	 * method requires SAFE_MODULE_READONLY or SAFE_MODULE permission. return
	 * value == 0 : Not tampered == 1 : Tampered
	 */
	 ...
	 * @param length
	 *            the length of the buffer. return value >= 0 : success (suggest
	 *            0) <0 : error code
	 */
	 ...
	 *            supported. return value >=0 : success (suggest 0) <0 : error
	 *            code
	 */
	 ...
	 * @param bufMaxLength
	 *            the max length of the result buffer. return value >=0 : the
	 ...
	 *            CERT_TYPE_APP_ROOT or CERT_TYPE_COMMUNICATE.
	 * @param alias
	 *            the alias of the certificate return value >=0 : success
	 ...
	 * 
	 * @param aliasPrivateKey
	 *            the alias of the private key. return value >=0 : success
	 *            (suggest 0) <0 : error code
	 */
	public native static int deleteKeyPair(String aliasPrivateKey);

	/**
	 * Generate the CSR for given private key. This method requires SAVE_MODULE
	 * permission.
	 * 
	 * @param alias
	 *            the alias of the private key
	 ...
	 * @param resMaxLength
	 *            the max length of the result buffer. return value >=0 :
	 *            success, with the valid length of the bufResult. <0 : error
	 *            code
	 */
	 ...
	 * padding format. This method requires SAFE_MODULE permission.
	 * 
	 * @param aliasPrivateKey
	 ...
	 * @param resMaxLength
	 *            the max length of the output buffer. return value >=0 :
	 *            encrypt success and return the length of the bufResult. <0 :
	 *            error code.
	 */
