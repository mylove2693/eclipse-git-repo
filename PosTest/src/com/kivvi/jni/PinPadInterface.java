 ...
 * android.permission.CYNOVO_PIN_GET_PIN_BLOCK
 * android.permission.CYNOVO_PIN_MAC
...
public class PinPadInterface {
	 ...
	 * @return 
	 *  - value  < 0 : error code, maybe, your display string is too long!
	 ...
	 * @param nAlgorith
	 *            : 1 : 3DES, 0 : DES return value < 0 : error code >= 0 :
	 *            success (suggest 0)
	 */
	 ...
	 * @return 
	 *  - value  < 0 : error code
	 *  - value >= 0 : success, length of cipher text length
	 */
	 ...
	 * @param[in]   nTimeout_MS          : timeout waiting for user input in milliseconds, if it is less than zero, then wait forever
	 * @param[in]   nFlagSound           : 0 : no voice prompt, 1 : voice prompt
	 * @return 
	 *  - value  < 0 : error code
	 *  - value >= 0 : success, length of pin block
	 */
	 ...
	 * @return 
	 *  - value  < 0 : error code
	 *  - value >= 0 : success, length of MAC data buffer
	 */
	 ...
	 * @param[in]  nCipherNewUserKeyLength  : length of new user key in cipher text
	 * @return 
	 *  - value  < 0 : error code
	 *  - value >= 0 : success (suggest 0)
	 */
