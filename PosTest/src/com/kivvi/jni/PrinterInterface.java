...
public class PrinterInterface {
	 ...
	 *                 - the Integer of default printer(1st printer)represents 00000001(binary) or 00000000(binary), return value is 1 or 0. 
	 ...
	 * @note  0 or 1 as default printer(1st printer), 2 as supplemental printer(2nd printer)
	 */
	public native static int open();
	
	/**
	 * close the device (all opened printers)
	 * @note  when the application complete print request, the application MUST invoke close() to release the printers for other application to allocate printer resource.
	 * @return 
	 *  - value == 0 : success
	...
	/**
	 * prepare to print ,lock current thread ,and check if the setted printer paper out
	 * @return 
	 *  - value == 0 : success
	 *  - value  < 0 : error code,  -1 :paper out, -2 : do not support check paper command(Can continue to operate), -10 : unknown error
	 */		
	public native static int begin();
	
	/** 
	 * end to print (current setted printer), unlock current thread,clean all the settings of this print task process
	 * @return 
	 *  - value == 0 : success
	 *  - value  < 0 : error code,  -1 : parameter mismatch, -2 : I/O error, -10 : unknown error
