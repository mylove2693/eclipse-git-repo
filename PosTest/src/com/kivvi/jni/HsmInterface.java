...
public class HsmInterface {
     ...
     * @param bufRandom[out]     :the buffer to store random bytes.
     ...
     * @param alias[out]         :the alias of the private key.
     * @param algorithm[in]      :the algorithm of the key pair. Currently, only ALGORITHM_RSA is supported.
     * @param keySize[in]        :the bit size of the key. Currently, only 2048 is supported.
     * @return 
     *  - value >= 0 : success (suggest 0)
     *  - value  < 0 : error code
     */
     ...
     * @return 
     *   - value >=0 : the length of the certificate PEM data.
     *   - value  <0 : error code
     */
     ...
     * @return 
     *   - value >=0 : success, with the valid length of the bufResult.
     *   - value  <0 : error code
     */
     ...
     * @return
     *   value >=0 : encrypt success and return the length of the bufResult.
     *   value  <0 : error code.
     */
